 ...
 * 公文流程
 */
public class DocumentScheduleFragment2 extends MyLazyFragment implements ScrollableHelper.ScrollableContainer {
    ...
    public static DocumentScheduleFragment2 newInstance() {
        return new DocumentScheduleFragment2();
    }
