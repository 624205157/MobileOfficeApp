 ...
 * 公文处理
 */
public class DocumentProcessingFragment2 extends MyLazyFragment implements ScrollableHelper.ScrollableContainer, View.OnClickListener {
    ...
    public static DocumentProcessingFragment2 newInstance() {
        return new DocumentProcessingFragment2();
    }
