...
public class SignatureNewView extends View {
    ...
    public SignatureNewView(Context context) {
        this(context, null);
    }

    public SignatureNewView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SignatureNewView(Context context, AttributeSet attrs, int defStyleAttr) {
