...
public class MailSender {
     ...
     */
    public boolean sendTextMail(final EmailInfo mailInfo) {
        ...
        if (mailInfo.isValidate()) {
            // 如果需要身份认证，则创建一个密码验证器
            authenticator = new EmailMyAuthenticator(mailInfo.getUserName(), mailInfo.getPassword());
        }
...
//      });
     ...
     * @return
     */
    public boolean sendFileMail(EmailInfo info, File file){
     ...
     * @return
     */
    private Message createAttachmentMail(final EmailInfo info, File file) {
        //创建邮件
